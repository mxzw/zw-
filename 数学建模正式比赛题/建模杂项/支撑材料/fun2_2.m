...
QB1 = [QB_S(1:5000) ; QB_S(1:5000) ; QB_S(1:5000) ; QB_S(1:5000) ; QB_S(1:5000) ; QB_S(1:5000) ; QB_S(1:5000) ; QB_S(1:5000) ; QB_S(1:5000) ; QB_S(1:5000) ; QB_S(1:5000) ; QB_S(1:5000) ; QB_S(1:5000) ; QB_S(1:5000) ; QB_S(1:5000) ; QB_S(1:5000) ; QB_S(1:5000) ; QB_S(1:5000) ; QB_S(1:5000) ; QB_S(1:5001) ];
%%
PA = zeros(100001,1);
PB = zeros(100001,1);
